...
\vspace{4pt}
Everything CARCASS produces serves one end: a research dataset with verifiable
...
never used for a data series. Every coloured value carries a label --- colour is
