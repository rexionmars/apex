...
\begin{itemize}[leftmargin=1.3em,itemsep=3pt]
  ...
  \item \textbf{Analysis.} Run trained models over the images: fat segmentation
        ...
        conformation (convexity) measure. All run with automatic background
...
a scientific \emph{instrument} to be scanned and operated, not read top to bottom.
It follows the visual language of mission-control software: a dark
...
the project's own findings (Station~13). The software surfaces them for two
reasons: they are useful as exploratory references, and the dataset it builds is
exactly what is needed to validate them in the future. It never presents them as
settled facts.
