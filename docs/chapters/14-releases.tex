...
Windows and Linux --- bundles the model weights into each build, and attaches the
archives to a GitHub Release with auto-generated notes.
...
is a set of ready-to-run binaries that need no build tools --- only, for the model
features, a Python environment with the scientific libraries.
\end{note}
