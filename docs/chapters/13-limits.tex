...
\vspace{4pt}
CARCASS is built to be honest about the boundary between what its measurements
...
paired to images, on a larger sample. That is precisely what CARCASS is built to
...
reference and the assessor grades --- closing the loop that the earlier research
could not.
...
CARCASS exists to fix that first. Every honest limitation above is a reason the
