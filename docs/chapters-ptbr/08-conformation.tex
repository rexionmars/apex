...
para dentro (côncavo). O Apex traduz essa regra em uma medida numérica.
...
diferenciar, o que a torna robusta ao ruído da máscara, e produz um valor:
...
O mapa é consistente com a anatomia sem qualquer rótulo: as pernas são
...
a conformação não é recuperável de forma confiável a partir de uma única imagem 2D neste
tamanho de amostra (Estação~13). O grau serve como referência indicativa, a ser
validada à medida que o conjunto de dados pareado cresce.
\end{caution}
